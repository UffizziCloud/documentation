...
Uffizzi Enterprise includes both the data plane and control plane components of Uffizzi and is designed to be installed on a Kubernetes cluster that you own and operate.   
