...
<Callout type="info">
    Uffizzi CLI is a standalone tool that works with either [Uffizzi Cloud](/cloud) or a self-hosted installation of [Uffizzi Business](/self-hosted/business) or [Uffizzi Enterprise](/self-hosted/enterprise). Alternatively, you can to use the [Dashboard](/usage/dashboard) web UI.
</Callout>
...
[Uffizzi Cloud](/cloud) and [Uffizzi Business](/install/platform/business) users should select `app.uffizzi.com` as the default server:
...
For [Uffizzi Enterprise](/self-hosted/enterprise) customers, use the API server URL provided by your andminstrator and enter it when prompted.
