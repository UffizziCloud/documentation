...
<Callout type="info">
    Uffizzi CLI is a standalone tool that works with either [Uffizzi Cloud](/cloud) or a self-hosted installation of [Uffizzi Pro](/pro) or [Uffizzi Enterprise](/enterprise). Alternatively, you can to use the [Dashboard](/usage/dashboard) web UI.
</Callout>
...
[Uffizzi Cloud](/cloud) and [Uffizzi Pro](/install/pro) users should select `app.uffizzi.com` as the default server:
