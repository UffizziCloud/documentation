...
Install Uffizzi Pro to create [ephemeral environments](/core-concepts/ephemeral-environments) on your own Kubernetes cluster.  
...
This command will remove the Uffizzi Controller and Uffizzi Cluster Operator from your cluster, as well as any other resources created by Uffizzi.
