...
<Callout type="info">
    ...
    instance of Kubernetes, such as minikube. To host both the Uffizzi data plane and control plane without the need for over-network communication, email sales@uffizzi.com about [Uffizzi Enterprise](/enterprise).
</Callout>
