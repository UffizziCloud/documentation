...
Follow the example guide below to see how the Uffizzi virtual cluster integration with GitHub Actions works end-to-end. Or you can [skip ahead](/ci/github-actions/recipe) to the recipe if you'd rather get started integrating Uffizzi with your project.
