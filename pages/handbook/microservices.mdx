...
# Microservices in Compose with Nginx

**A guide on how you can support your microservices architecture on Uffizzi Compose environments through Nginx**  
...
<br />
<Image
    src="/images/voting-app-architecture.webp"
    width={640}
    height={433}
    alt="Voting application microservices architecture"
...
<br />
<Image
    src="/images/microservices-architecture-with-nginx.webp"
    width={640}
    height={433}
    alt="Microservices architecture with nginx"
    className="border rounded-lg overflow-hidden mt-6"
/>
<br />
...
We will create a new configuration file called `nginx.conf` and define how Nginx should handle request routing. Please make sure this file is placed under a directory, and the total size of the directory is smaller than 1 MB compressed. If you’re having trouble configuring volumes, read our [troubleshooting guide](../troubleshooting/most-common-problems.md).  
