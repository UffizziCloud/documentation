...
Use Uffizzi [dev clusters](/docs/core-concepts/dev-clusters) for continuous development and deployment and 
[virtual clusters](/docs/core-concepts/virtual-clusters) to test pre-production releases or against [different versions of 
