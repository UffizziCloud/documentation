...
<br />
<Image
    src="/../public/images/dev-environment.png"
    width={640}
    height={433}
...
and container restarts for every small code change, the [`uffizzi dev`](/docs/cli/commands/dev) command significantly reduces the time between writing code and seeing 
...
where `CONFIG_FILE` is the path to a [Skaffold file](/docs/dev-environments/skaffold).
...
guide [Using Dev Clusters](/docs/dev-environments/dev-clusters).