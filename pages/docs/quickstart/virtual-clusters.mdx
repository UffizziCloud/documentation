...
Create a Kubernetes [virtual cluster](/docs/core-concepts/ephemeral-environments/virtual-clusters) and deploy an example application.
...
### Create a cluster  
  ...
  This repo includes a [`web.yaml`](https://github.com/UffizziCloud/quickstart/blob/main/manifests/web.yaml) manifest that includes `service`, `ingress` and `deployment` resources.
