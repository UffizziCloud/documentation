...
# Installing Uffizzi
 ...
 This guide describes how to **install and configure the CLI** for use with [Uffizzi Cloud](/docs/cloud) or a private managed version of [Uffizzi Enterprise](/docs/enterprise).

<Callout className="mt-6">
  **Note:** If you want to install the full Uffizzi platform, including the API server, [contact sales](mailto:sales@uffizzi.com) or try the [open-source version](/docs/open-source). You can also reach out on [Slack](https://join.slack.com/t/uffizzi/shared_invite/zt-24toel26u-4JB2pLqdUnrt2qJcWoLcDA) to get help.
</Callout>
