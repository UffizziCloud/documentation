...
The Uffizzi Controller smart proxy service that handles requests from Uffizzi API to the host Kubernetes API. The Uffizzi Controller installs on a host cluster in its own namespace.  
