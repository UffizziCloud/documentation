...
List all virtual clusters for the default account and project context. See [account](/cli/commands/account) and [config](cli.md#config) for details about changing default account or project contexts.
