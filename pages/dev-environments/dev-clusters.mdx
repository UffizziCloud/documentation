...
1. **A [`skaffold.yaml`](https://skaffold.dev/references/yaml/) file**  
...
Uffizzi dev clusters require a [`skaffold.yaml`](https://skaffold.dev/references/yaml/) configuration file 
