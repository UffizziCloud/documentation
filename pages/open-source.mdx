...
Included in Uffizzi Open Source are the folllowing components: [API server](https://github.com/UffizziCloud/uffizzi), [controller](https://github.com/UffizziCloud/uffizzi_controller), 
[cluster operator](https://github.com/UffizziCloud/uffizzi-cluster-operator), and [CLI](https://github.com/UffizziCloud/uffizzi_cli). These components together allow users to obtain the core 
